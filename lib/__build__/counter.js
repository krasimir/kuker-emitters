...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  var render = function render() {
    ...
    return _c("div", { attrs: { id: "app" } }, [_vm._v("\n  Clicked: " + _vm._s(_vm.$store.state.count) + " times, count is " + _vm._s(_vm.evenOrOdd) + ".\n  "), _c("button", { on: { click: _vm.increment } }, [_vm._v("+")]), _vm._v(" "), _c("button", { on: { click: _vm.decrement } }, [_vm._v("-")]), _vm._v(" "), _c("button", { on: { click: _vm.incrementIfOdd } }, [_vm._v("Increment if odd")]), _vm._v(" "), _c("button", { on: { click: _vm.incrementAsync } }, [_vm._v("Increment async")])]);
  };
  var staticRenderFns = [];
